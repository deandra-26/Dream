...
const FORMATIONS = {
  "1-3-1": {
    ...
    lines: { "Exp Laner": "Atas", Jungler: "Tengah", Roamer: "Tengah", "Mid Laner": "Tengah", "Gold Laner": "Bawah" },
  },
  "2-1-2": {
    label: "Serang Total",
    accent: "#FB7185",
    ...
    lines: { "Exp Laner": "Atas", "Mid Laner": "Atas", Jungler: "Tengah", Roamer: "Bawah", "Gold Laner": "Bawah" },
  },
  "3-1-1": {
    ...
    lines: { "Exp Laner": "Atas", Roamer: "Atas", "Mid Laner": "Atas", Jungler: "Tengah", "Gold Laner": "Bawah" },
  },
  "1-1-3": {
    ...
    lines: { "Exp Laner": "Atas", Jungler: "Tengah", Roamer: "Bawah", "Mid Laner": "Bawah", "Gold Laner": "Bawah" },
  },
  "2-2-1": {
    label: "Kontrol Map",
    accent: "#34D399",
    ...
    lines: { "Exp Laner": "Atas", Roamer: "Atas", "Mid Laner": "Tengah", Jungler: "Tengah", "Gold Laner": "Bawah" },
  },
  "0-5-0": {
    label: "Straight Push",
    accent: "#F87171",
      ...
      <div className="ldm-container">
          ...
          <div className="ldm-card">
            <div className="ldm-draft-header">
              <div className="ldm-draft-pick">
                ...
                <span>MATCH {currentMatchIndex + 1} / {aiTeams.length * TOTAL_LEGS} &middot; LEG {getCurrentLeg()}</span>
              </div>
        ...
        {phase === "standings" && season && (
          <div>
            ...
            {(() => {
              const finalName = userTeamName.trim() || "Timku FC";
              const userRank = season.table.findIndex((t) => t.name === finalName);
              const qualified = userRank < 6;
              return (
                <p className="ldm-text-small" style={{ margin: "16px 0" }}>
                  {qualified
                    ? `Timmu finish di posisi ke-${userRank + 1} — lolos ke playoff! Kamu bakal main tiap match yang melibatkan timmu.`
                    : `Timmu finish di posisi ke-${userRank + 1}, gak lolos 6 besar. Playoff tetap berjalan buat nentuin juara antar tim lain.`}
                </p>
              );
            })()}
